    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('Admin', 'Admin'), ('User', 'User'), ('Editor', 'Editor'), ('Manager', 'Manager'), ('HR', 'HR'), ('Employee', 'Employee')], max_length=255, null=True, verbose_name='Role')),
